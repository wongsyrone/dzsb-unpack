...
.method public run()V
    ...
    invoke-static {v5, v6}, Lcom/tencent/open/utils/OpenConfig;->getInstance(Landroid/content/Context;Ljava/lang/String;)Lcom/tencent/open/utils/OpenConfig;

    move-result-object v5

    const-string v7, "Common_HttpRetryCount"

    invoke-virtual {v5, v7}, Lcom/tencent/open/utils/OpenConfig;->getInt(Ljava/lang/String;)I
