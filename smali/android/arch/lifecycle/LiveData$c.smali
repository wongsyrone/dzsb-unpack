...
# direct methods
.method public constructor <init>(Landroid/arch/lifecycle/LiveData;Lg/k;)V
    .locals 0
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    .line 3
    iput-object p2, p0, Landroid/arch/lifecycle/LiveData$c;->a:Lg/k;
...
.method public h(Z)V
    ...
    invoke-static {p1}, Landroid/arch/lifecycle/LiveData;->f(Landroid/arch/lifecycle/LiveData;)I
    ...
    invoke-static {v1}, Landroid/arch/lifecycle/LiveData;->f(Landroid/arch/lifecycle/LiveData;)I
    ...
    invoke-static {v1, v2}, Landroid/arch/lifecycle/LiveData;->g(Landroid/arch/lifecycle/LiveData;I)I
    ...
    invoke-virtual {p1}, Landroid/arch/lifecycle/LiveData;->r()V
    ...
    invoke-virtual {p1}, Landroid/arch/lifecycle/LiveData;->s()V
    ...
    invoke-static {p1, p0}, Landroid/arch/lifecycle/LiveData;->h(Landroid/arch/lifecycle/LiveData;Landroid/arch/lifecycle/LiveData$c;)V
