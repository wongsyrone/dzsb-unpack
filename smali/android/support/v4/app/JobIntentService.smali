...
# instance fields
.field public a:Landroid/support/v4/app/JobIntentService$b;

.field public b:Landroid/support/v4/app/JobIntentService$h;

.field public c:Landroid/support/v4/app/JobIntentService$a;
...
.method public static c(Landroid/content/Context;Landroid/content/ComponentName;ILandroid/content/Intent;)V
    ...
    .line 1
    sget-object v0, Landroid/support/v4/app/JobIntentService;->j:Ljava/lang/Object;
    ...
    .line 2
    :try_start_0
    invoke-static {p0, p1, v1, p2}, Landroid/support/v4/app/JobIntentService;->f(Landroid/content/Context;Landroid/content/ComponentName;ZI)Landroid/support/v4/app/JobIntentService$h;

    move-result-object p0

    .line 3
    invoke-virtual {p0, p2}, Landroid/support/v4/app/JobIntentService$h;->b(I)V
...
.method public static d(Landroid/content/Context;Ljava/lang/Class;ILandroid/content/Intent;)V
    ...
    invoke-static {p0, v0, p2, p3}, Landroid/support/v4/app/JobIntentService;->c(Landroid/content/Context;Landroid/content/ComponentName;ILandroid/content/Intent;)V

    return-void
.end method

.method public static f(Landroid/content/Context;Landroid/content/ComponentName;ZI)Landroid/support/v4/app/JobIntentService$h;
    .locals 2
    ...
    .line 6
    sget-object p0, Landroid/support/v4/app/JobIntentService;->k:Ljava/util/HashMap;
...
.method public b()Z
    ...
    .line 4
    invoke-virtual {p0}, Landroid/support/v4/app/JobIntentService;->i()Z
...
.method public e(Z)V
    ...
    .line 4
    invoke-virtual {v0}, Landroid/support/v4/app/JobIntentService$h;->d()V
...
.method public j()V
    ...
    .line 5
    invoke-virtual {p0, v1}, Landroid/support/v4/app/JobIntentService;->e(Z)V
...
.method public onCreate()V
    ...
    .line 7
    invoke-static {p0, v0, v1, v1}, Landroid/support/v4/app/JobIntentService;->f(Landroid/content/Context;Landroid/content/ComponentName;ZI)Landroid/support/v4/app/JobIntentService$h;
...
.method public onStartCommand(Landroid/content/Intent;II)I
    ...
    invoke-virtual {p2}, Landroid/support/v4/app/JobIntentService$h;->e()V
    ...
    .line 5
    invoke-virtual {p0, p1}, Landroid/support/v4/app/JobIntentService;->e(Z)V
