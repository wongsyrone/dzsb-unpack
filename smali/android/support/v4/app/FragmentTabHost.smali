...
.field public g:Landroid/support/v4/app/FragmentTabHost$b;
...
.method public constructor <init>(Landroid/content/Context;)V
    ...
    .line 3
    invoke-direct {p0, p1, v0}, Landroid/support/v4/app/FragmentTabHost;->f(Landroid/content/Context;Landroid/util/AttributeSet;)V
...
.method public constructor <init>(Landroid/content/Context;Landroid/util/AttributeSet;)V
    ...
    .line 6
    invoke-direct {p0, p1, p2}, Landroid/support/v4/app/FragmentTabHost;->f(Landroid/content/Context;Landroid/util/AttributeSet;)V

    return-void
.end method

.method private b(Ljava/lang/String;Lw/u;)Lw/u;
    .locals 3
    ...
    .line 1
    invoke-direct {p0, p1}, Landroid/support/v4/app/FragmentTabHost;->e(Ljava/lang/String;)Landroid/support/v4/app/FragmentTabHost$b;
    ...
    .line 3
    iget-object p2, p0, Landroid/support/v4/app/FragmentTabHost;->d:Lw/p;

    invoke-virtual {p2}, Lw/p;->b()Lw/u;
    ...
    .line 6
    invoke-virtual {p2, v0}, Lw/u;->p(Landroid/support/v4/app/Fragment;)Lw/u;

    :cond_1
    if-eqz p1, :cond_3

    .line 7
    iget-object v0, p1, Landroid/support/v4/app/FragmentTabHost$b;->d:Landroid/support/v4/app/Fragment;
    ...
    iget-object v1, p1, Landroid/support/v4/app/FragmentTabHost$b;->b:Ljava/lang/Class;
    ...
    iget-object v2, p1, Landroid/support/v4/app/FragmentTabHost$b;->c:Landroid/os/Bundle;
    ...
    iput-object v0, p1, Landroid/support/v4/app/FragmentTabHost$b;->d:Landroid/support/v4/app/Fragment;
    ...
    invoke-virtual {p2, v1, v0, v2}, Lw/u;->g(ILandroid/support/v4/app/Fragment;Ljava/lang/String;)Lw/u;

    goto :goto_0

    .line 12
    :cond_2
    invoke-virtual {p2, v0}, Lw/u;->k(Landroid/support/v4/app/Fragment;)Lw/u;

    .line 13
    :cond_3
    :goto_0
    iput-object p1, p0, Landroid/support/v4/app/FragmentTabHost;->g:Landroid/support/v4/app/FragmentTabHost$b;
...
.method private d(Landroid/content/Context;)V
    ...
    .line 13
    iget p1, p0, Landroid/support/v4/app/FragmentTabHost;->e:I
...
.method private e(Ljava/lang/String;)Landroid/support/v4/app/FragmentTabHost$b;
    .locals 4
    .annotation build Lj/g0;
    .end annotation
...
.method public a(Landroid/widget/TabHost$TabSpec;Ljava/lang/Class;Landroid/os/Bundle;)V
    ...
    invoke-virtual {p2, v0}, Lw/p;->g(Ljava/lang/String;)Landroid/support/v4/app/Fragment;

    move-result-object p2

    iput-object p2, v1, Landroid/support/v4/app/FragmentTabHost$b;->d:Landroid/support/v4/app/Fragment;
    ...
    .line 8
    iget-object p3, v1, Landroid/support/v4/app/FragmentTabHost$b;->d:Landroid/support/v4/app/Fragment;

    invoke-virtual {p2, p3}, Lw/u;->p(Landroid/support/v4/app/Fragment;)Lw/u;

    .line 9
    invoke-virtual {p2}, Lw/u;->l()I
...
.method public g(Landroid/content/Context;Lw/p;)V
    .locals 0

    .line 1
    invoke-direct {p0, p1}, Landroid/support/v4/app/FragmentTabHost;->d(Landroid/content/Context;)V
    ...
    .line 4
    iput-object p2, p0, Landroid/support/v4/app/FragmentTabHost;->d:Lw/p;

    .line 5
    invoke-direct {p0}, Landroid/support/v4/app/FragmentTabHost;->c()V

    return-void
.end method

.method public h(Landroid/content/Context;Lw/p;I)V
    .locals 0
...
.method public onAttachedToWindow()V
    ...
    .line 5
    iget-object v5, p0, Landroid/support/v4/app/FragmentTabHost;->d:Lw/p;

    iget-object v6, v4, Landroid/support/v4/app/FragmentTabHost$b;->a:Ljava/lang/String;

    invoke-virtual {v5, v6}, Lw/p;->g(Ljava/lang/String;)Landroid/support/v4/app/Fragment;

    move-result-object v5

    iput-object v5, v4, Landroid/support/v4/app/FragmentTabHost$b;->d:Landroid/support/v4/app/Fragment;
    ...
    .line 8
    iput-object v4, p0, Landroid/support/v4/app/FragmentTabHost;->g:Landroid/support/v4/app/FragmentTabHost$b;
    ...
    .line 9
    iget-object v2, p0, Landroid/support/v4/app/FragmentTabHost;->d:Lw/p;

    invoke-virtual {v2}, Lw/p;->b()Lw/u;

    move-result-object v2

    .line 10
    :cond_1
    iget-object v4, v4, Landroid/support/v4/app/FragmentTabHost$b;->d:Landroid/support/v4/app/Fragment;

    invoke-virtual {v2, v4}, Lw/u;->p(Landroid/support/v4/app/Fragment;)Lw/u;
    ...
    .line 12
    invoke-direct {p0, v0, v2}, Landroid/support/v4/app/FragmentTabHost;->b(Ljava/lang/String;Lw/u;)Lw/u;
    ...
    .line 14
    iget-object v0, p0, Landroid/support/v4/app/FragmentTabHost;->d:Lw/p;

    invoke-virtual {v0}, Lw/p;->e()Z
...
.method public onTabChanged(Ljava/lang/String;)V
    ...
    .line 2
    invoke-direct {p0, p1, v0}, Landroid/support/v4/app/FragmentTabHost;->b(Ljava/lang/String;Lw/u;)Lw/u;
