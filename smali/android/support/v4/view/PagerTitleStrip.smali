...
.field public final k:Landroid/support/v4/view/PagerTitleStrip$a;
...
.method public constructor <init>(Landroid/content/Context;Landroid/util/AttributeSet;)V
    ...
    iput-object v0, p0, Landroid/support/v4/view/PagerTitleStrip;->k:Landroid/support/v4/view/PagerTitleStrip$a;
    ...
    .line 9
    sget-object v0, Landroid/support/v4/view/PagerTitleStrip;->o:[I
    ...
    invoke-static {v2, v1}, Lv0/u;->p(Landroid/widget/TextView;I)V
    ...
    iput v2, p0, Landroid/support/v4/view/PagerTitleStrip;->h:I
    ...
    iput p2, p0, Landroid/support/v4/view/PagerTitleStrip;->n:I
    ...
    .line 28
    sget-object p2, Landroid/support/v4/view/PagerTitleStrip;->p:[I
...
.method public b(Ls0/t;Ls0/t;)V
    ...
    invoke-virtual {p1, v0}, Ls0/t;->u(Landroid/database/DataSetObserver;)V

    const/4 p1, 0x0

    .line 2
    iput-object p1, p0, Landroid/support/v4/view/PagerTitleStrip;->l:Ljava/lang/ref/WeakReference;

    :cond_0
    if-eqz p2, :cond_1

    .line 3
    iget-object p1, p0, Landroid/support/v4/view/PagerTitleStrip;->k:Landroid/support/v4/view/PagerTitleStrip$a;

    invoke-virtual {p2, p1}, Ls0/t;->m(Landroid/database/DataSetObserver;)V
    ...
    invoke-virtual {p0, p1, p2}, Landroid/support/v4/view/PagerTitleStrip;->c(ILs0/t;)V
...
.method public c(ILs0/t;)V
    ...
    .line 2
    iput-boolean v2, p0, Landroid/support/v4/view/PagerTitleStrip;->i:Z
    ...
    .line 3
    invoke-virtual {p2, v2}, Ls0/t;->g(I)Ljava/lang/CharSequence;
    ...
    .line 6
    invoke-virtual {p2, p1}, Ls0/t;->g(I)Ljava/lang/CharSequence;
    ...
    .line 20
    iget-boolean p2, p0, Landroid/support/v4/view/PagerTitleStrip;->j:Z

    if-nez p2, :cond_4

    .line 21
    iget p2, p0, Landroid/support/v4/view/PagerTitleStrip;->f:F

    invoke-virtual {p0, p1, p2, v0}, Landroid/support/v4/view/PagerTitleStrip;->d(IFZ)V
...
.method public d(IFZ)V
    ...
    .line 1
    iget v3, v0, Landroid/support/v4/view/PagerTitleStrip;->e:I
    ...
    invoke-virtual {v3}, Landroid/support/v4/view/ViewPager;->getAdapter()Ls0/t;

    move-result-object v3

    invoke-virtual {v0, v1, v3}, Landroid/support/v4/view/PagerTitleStrip;->c(ILs0/t;)V
    ...
    .line 3
    iget v1, v0, Landroid/support/v4/view/PagerTitleStrip;->f:F
    ...
    .line 4
    iput-boolean v1, v0, Landroid/support/v4/view/PagerTitleStrip;->j:Z
    ...
    .line 32
    iget v1, v0, Landroid/support/v4/view/PagerTitleStrip;->g:I
    ...
    .line 36
    iput v1, v0, Landroid/support/v4/view/PagerTitleStrip;->f:F
...
.method public getTextSpacing()I
    ...
    .line 1
    iget v0, p0, Landroid/support/v4/view/PagerTitleStrip;->g:I
...
.method public onAttachedToWindow()V
    ...
    .line 5
    invoke-virtual {v0}, Landroid/support/v4/view/ViewPager;->getAdapter()Ls0/t;
    ...
    invoke-virtual {v0, v2}, Landroid/support/v4/view/ViewPager;->V(Landroid/support/v4/view/ViewPager$i;)Landroid/support/v4/view/ViewPager$i;

    .line 7
    iget-object v2, p0, Landroid/support/v4/view/PagerTitleStrip;->k:Landroid/support/v4/view/PagerTitleStrip$a;

    invoke-virtual {v0, v2}, Landroid/support/v4/view/ViewPager;->b(Landroid/support/v4/view/ViewPager$h;)V
    ...
    :goto_0
    invoke-virtual {p0, v0, v1}, Landroid/support/v4/view/PagerTitleStrip;->b(Ls0/t;Ls0/t;)V
...
.method public onDetachedFromWindow()V
    ...
    invoke-virtual {v0, v1}, Landroid/support/v4/view/ViewPager;->V(Landroid/support/v4/view/ViewPager$i;)Landroid/support/v4/view/ViewPager$i;
    ...
    invoke-virtual {v0, v2}, Landroid/support/v4/view/ViewPager;->N(Landroid/support/v4/view/ViewPager$h;)V
...
.method public onLayout(ZIIII)V
    ...
    .line 2
    iget p1, p0, Landroid/support/v4/view/PagerTitleStrip;->f:F
    ...
    .line 3
    :goto_0
    iget p2, p0, Landroid/support/v4/view/PagerTitleStrip;->e:I

    const/4 p3, 0x1

    invoke-virtual {p0, p2, p1, p3}, Landroid/support/v4/view/PagerTitleStrip;->d(IFZ)V
...
.method public setNonPrimaryAlpha(F)V
    ...
    .line 1
    iput p1, p0, Landroid/support/v4/view/PagerTitleStrip;->m:I

    shl-int/lit8 p1, p1, 0x18

    .line 2
    iget v0, p0, Landroid/support/v4/view/PagerTitleStrip;->n:I
...
.method public setTextColor(I)V
    ...
    .line 1
    iput p1, p0, Landroid/support/v4/view/PagerTitleStrip;->n:I
    ...
    .line 3
    iget p1, p0, Landroid/support/v4/view/PagerTitleStrip;->m:I
