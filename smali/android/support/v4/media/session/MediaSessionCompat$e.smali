...
.method public C(Landroid/app/PendingIntent;Landroid/content/ComponentName;)V
    ...
    .line 6
    invoke-super {p0, p1, p2}, Landroid/support/v4/media/session/MediaSessionCompat$h;->C(Landroid/app/PendingIntent;Landroid/content/ComponentName;)V
...
.method public O(Landroid/support/v4/media/session/PlaybackStateCompat;)V
    ...
    .line 2
    invoke-virtual {p1}, Landroid/support/v4/media/session/PlaybackStateCompat;->j()F
...
.method public Q(Landroid/app/PendingIntent;Landroid/content/ComponentName;)V
    ...
    .line 3
    :cond_0
    invoke-super {p0, p1, p2}, Landroid/support/v4/media/session/MediaSessionCompat$h;->Q(Landroid/app/PendingIntent;Landroid/content/ComponentName;)V
...
.method public e(Landroid/support/v4/media/session/MediaSessionCompat$c;Landroid/os/Handler;)V
    ...
    .line 1
    invoke-super {p0, p1, p2}, Landroid/support/v4/media/session/MediaSessionCompat$h;->e(Landroid/support/v4/media/session/MediaSessionCompat$c;Landroid/os/Handler;)V
...
.method public v(J)I
    ...
    .line 1
    invoke-super {p0, p1, p2}, Landroid/support/v4/media/session/MediaSessionCompat$h;->v(J)I
