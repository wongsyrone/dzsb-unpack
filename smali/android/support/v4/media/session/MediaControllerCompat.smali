...
.method public static C(Landroid/app/Activity;Landroid/support/v4/media/session/MediaControllerCompat;)V
    ...
    .line 4
    invoke-virtual {p1}, Landroid/support/v4/media/session/MediaControllerCompat;->s()Landroid/support/v4/media/session/MediaSessionCompat$Token;
    ...
    .line 5
    invoke-static {p0, p1}, Lk0/c;->d(Landroid/content/Context;Ljava/lang/Object;)Ljava/lang/Object;

    move-result-object v0

    .line 6
    :cond_1
    invoke-static {p0, v0}, Lk0/c;->t(Landroid/app/Activity;Ljava/lang/Object;)V
...
.method public static synthetic a(Ljava/lang/String;Landroid/os/Bundle;)V
    ...
    .line 1
    invoke-static {p0, p1}, Landroid/support/v4/media/session/MediaControllerCompat;->F(Ljava/lang/String;Landroid/os/Bundle;)V

    return-void
.end method

.method public static h(Landroid/app/Activity;)Landroid/support/v4/media/session/MediaControllerCompat;
    .locals 3
    .param p0    # Landroid/app/Activity;
        .annotation build Lj/f0;
        .end annotation
    ...
    .line 6
    invoke-static {p0}, Lk0/c;->g(Landroid/app/Activity;)Ljava/lang/Object;
    ...
    .line 7
    :cond_2
    invoke-static {v0}, Lk0/c;->p(Ljava/lang/Object;)Ljava/lang/Object;
...
.method public A(I)V
    ...
    .line 1
    invoke-virtual {p0}, Landroid/support/v4/media/session/MediaControllerCompat;->n()Ljava/util/List;
...
.method public B(Ljava/lang/String;Landroid/os/Bundle;Landroid/os/ResultReceiver;)V
    ...
    invoke-interface {v0, p1, p2, p3}, Landroid/support/v4/media/session/MediaControllerCompat$c;->k(Ljava/lang/String;Landroid/os/Bundle;Landroid/os/ResultReceiver;)V
...
.method public D(II)V
    ...
    invoke-interface {v0, p1, p2}, Landroid/support/v4/media/session/MediaControllerCompat$c;->h(II)V
...
.method public E(Landroid/support/v4/media/session/MediaControllerCompat$a;)V
    ...
    invoke-interface {v1, p1}, Landroid/support/v4/media/session/MediaControllerCompat$c;->f(Landroid/support/v4/media/session/MediaControllerCompat$a;)V
    :try_end_0
...
.method public b(Landroid/support/v4/media/MediaDescriptionCompat;)V
    ...
    invoke-interface {v0, p1}, Landroid/support/v4/media/session/MediaControllerCompat$c;->d(Landroid/support/v4/media/MediaDescriptionCompat;)V
...
.method public c(Landroid/support/v4/media/MediaDescriptionCompat;I)V
    ...
    invoke-interface {v0, p1, p2}, Landroid/support/v4/media/session/MediaControllerCompat$c;->i(Landroid/support/v4/media/MediaDescriptionCompat;I)V
...
.method public e(Landroid/view/KeyEvent;)Z
    ...
    invoke-interface {v0, p1}, Landroid/support/v4/media/session/MediaControllerCompat$c;->g(Landroid/view/KeyEvent;)Z
...
.method public g()J
    ...
    invoke-interface {v0}, Landroid/support/v4/media/session/MediaControllerCompat$c;->y()J
...
.method public i()Ljava/lang/Object;
    ...
    invoke-interface {v0}, Landroid/support/v4/media/session/MediaControllerCompat$c;->o()Ljava/lang/Object;
...
.method public j()Landroid/support/v4/media/MediaMetadataCompat;
    .locals 1
...
.method public o()Ljava/lang/CharSequence;
    ...
    invoke-interface {v0}, Landroid/support/v4/media/session/MediaControllerCompat$c;->j()Ljava/lang/CharSequence;
...
.method public p()I
    ...
    invoke-interface {v0}, Landroid/support/v4/media/session/MediaControllerCompat$c;->e()I
...
.method public s()Landroid/support/v4/media/session/MediaSessionCompat$Token;
    .locals 1
...
.method public t()I
    ...
    invoke-interface {v0}, Landroid/support/v4/media/session/MediaControllerCompat$c;->s()I
...
.method public u()Landroid/support/v4/media/session/MediaControllerCompat$h;
    ...
    invoke-interface {v0}, Landroid/support/v4/media/session/MediaControllerCompat$c;->n()Landroid/support/v4/media/session/MediaControllerCompat$h;
...
.method public w()Z
    ...
    invoke-interface {v0}, Landroid/support/v4/media/session/MediaControllerCompat$c;->l()Z
...
.method public y(Landroid/support/v4/media/session/MediaControllerCompat$a;Landroid/os/Handler;)V
    ...
    invoke-interface {v0, p1, p2}, Landroid/support/v4/media/session/MediaControllerCompat$c;->p(Landroid/support/v4/media/session/MediaControllerCompat$a;Landroid/os/Handler;)V
...
.method public z(Landroid/support/v4/media/MediaDescriptionCompat;)V
    ...
    invoke-interface {v0, p1}, Landroid/support/v4/media/session/MediaControllerCompat$c;->c(Landroid/support/v4/media/MediaDescriptionCompat;)V
