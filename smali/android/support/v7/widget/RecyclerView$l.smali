...
# interfaces
.implements Landroid/support/v7/widget/RecyclerView$k$c;
...
.method public a(Landroid/support/v7/widget/RecyclerView$b0;)V
    ...
    .line 2
    iget-object v0, p1, Landroid/support/v7/widget/RecyclerView$b0;->h:Landroid/support/v7/widget/RecyclerView$b0;

    const/4 v1, 0x0

    if-eqz v0, :cond_0

    iget-object v0, p1, Landroid/support/v7/widget/RecyclerView$b0;->i:Landroid/support/v7/widget/RecyclerView$b0;

    if-nez v0, :cond_0

    .line 3
    iput-object v1, p1, Landroid/support/v7/widget/RecyclerView$b0;->h:Landroid/support/v7/widget/RecyclerView$b0;

    .line 4
    :cond_0
    iput-object v1, p1, Landroid/support/v7/widget/RecyclerView$b0;->i:Landroid/support/v7/widget/RecyclerView$b0;

    .line 5
    invoke-static {p1}, Landroid/support/v7/widget/RecyclerView$b0;->d(Landroid/support/v7/widget/RecyclerView$b0;)Z
    ...
    invoke-virtual {v0, v1}, Landroid/support/v7/widget/RecyclerView;->n1(Landroid/view/View;)Z
