...
# static fields
.field public static final n:Ljava/lang/String; = "ActionMenuItemView"
...
.field public f:Le1/h$b;

.field public g:Lf1/y;

.field public h:Landroid/support/v7/view/menu/ActionMenuItemView$b;
...
.method public constructor <init>(Landroid/content/Context;Landroid/util/AttributeSet;I)V
    ...
    .line 6
    sget-object v1, Lx0/b$l;->ActionMenuItemView:[I
    ...
    .line 7
    sget p2, Lx0/b$l;->ActionMenuItemView_android_minWidth:I
...
.method private i()V
    ...
    iget-object v2, p0, Landroid/support/v7/view/menu/ActionMenuItemView;->c:Le1/k;

    .line 3
    invoke-virtual {v2}, Le1/k;->C()Z
    ...
    invoke-virtual {v2}, Le1/k;->getContentDescription()Ljava/lang/CharSequence;
    ...
    invoke-virtual {v2}, Le1/k;->getTitle()Ljava/lang/CharSequence;
    ...
    invoke-virtual {v2}, Le1/k;->getTooltipText()Ljava/lang/CharSequence;
    ...
    .line 11
    :cond_5
    iget-object v0, p0, Landroid/support/v7/view/menu/ActionMenuItemView;->c:Le1/k;

    invoke-virtual {v0}, Le1/k;->getTitle()Ljava/lang/CharSequence;

    move-result-object v1

    :goto_4
    invoke-static {p0, v1}, Lf1/y0;->a(Landroid/view/View;Ljava/lang/CharSequence;)V

    goto :goto_5

    .line 12
    :cond_6
    invoke-static {p0, v2}, Lf1/y0;->a(Landroid/view/View;Ljava/lang/CharSequence;)V
...
.method public a()Z
    ...
    .line 1
    invoke-virtual {p0}, Landroid/support/v7/view/menu/ActionMenuItemView;->g()Z
...
.method public c()Z
    ...
    invoke-virtual {v0}, Le1/k;->getIcon()Landroid/graphics/drawable/Drawable;
...
.method public d(Le1/k;I)V
    .locals 0

    .line 1
    iput-object p1, p0, Landroid/support/v7/view/menu/ActionMenuItemView;->c:Le1/k;

    .line 2
    invoke-virtual {p1}, Le1/k;->getIcon()Landroid/graphics/drawable/Drawable;
    ...
    .line 3
    invoke-virtual {p1, p0}, Le1/k;->i(Le1/q$a;)Ljava/lang/CharSequence;
    ...
    .line 4
    invoke-virtual {p1}, Le1/k;->getItemId()I
    ...
    .line 5
    invoke-virtual {p1}, Le1/k;->isVisible()Z
    ...
    .line 8
    iget-object p1, p0, Landroid/support/v7/view/menu/ActionMenuItemView;->g:Lf1/y;
    ...
    iput-object p1, p0, Landroid/support/v7/view/menu/ActionMenuItemView;->g:Lf1/y;
...
.method public getItemData()Le1/k;
    .locals 1
...
.method public onClick(Landroid/view/View;)V
    ...
    .line 1
    iget-object p1, p0, Landroid/support/v7/view/menu/ActionMenuItemView;->f:Le1/h$b;
    ...
    invoke-interface {p1, v0}, Le1/h$b;->a(Le1/k;)Z
...
.method public onTouchEvent(Landroid/view/MotionEvent;)Z
    ...
    invoke-virtual {v0}, Le1/k;->hasSubMenu()Z

    move-result v0

    if-eqz v0, :cond_0

    iget-object v0, p0, Landroid/support/v7/view/menu/ActionMenuItemView;->g:Lf1/y;
...
.method public setExpandedFormat(Z)V
    ...
    .line 3
    iget-object p1, p0, Landroid/support/v7/view/menu/ActionMenuItemView;->c:Le1/k;

    if-eqz p1, :cond_0

    .line 4
    invoke-virtual {p1}, Le1/k;->c()V
...
.method public setItemInvoker(Le1/h$b;)V
    .locals 0

    .line 1
    iput-object p1, p0, Landroid/support/v7/view/menu/ActionMenuItemView;->f:Le1/h$b;
