...
.method public static a(Landroid/view/inputmethod/InputConnection;Landroid/view/inputmethod/EditorInfo;Ls/c;ILandroid/os/Bundle;)Z
    .locals 5
    ...
    .line 1
    invoke-virtual {p2}, Ls/c;->b()Landroid/content/ClipDescription;

    move-result-object v0

    .line 2
    invoke-static {p1}, Ls/a;->a(Landroid/view/inputmethod/EditorInfo;)[Ljava/lang/String;
    ...
    .line 5
    invoke-virtual {p2}, Ls/c;->f()Ljava/lang/Object;
    ...
    .line 8
    invoke-virtual {p2}, Ls/c;->a()Landroid/net/Uri;
    ...
    .line 10
    invoke-virtual {p2}, Ls/c;->c()Landroid/net/Uri;
...
.method public static b(Landroid/view/inputmethod/InputConnection;Landroid/view/inputmethod/EditorInfo;Ls/b$c;)Landroid/view/inputmethod/InputConnection;
    .locals 3
    .param p0    # Landroid/view/inputmethod/InputConnection;
        .annotation build Lj/f0;
        .end annotation
    ...
    .line 2
    new-instance p1, Ls/b$a;

    invoke-direct {p1, p0, v2, p2}, Ls/b$a;-><init>(Landroid/view/inputmethod/InputConnection;ZLs/b$c;)V
    ...
    invoke-direct {p1, p0, v2, p2}, Ls/b$b;-><init>(Landroid/view/inputmethod/InputConnection;ZLs/b$c;)V
...
.method public static c(Ljava/lang/String;Landroid/os/Bundle;Ls/b$c;)Z
    .locals 7
    ...
    invoke-direct {v6, v2, v3, v4}, Ls/c;-><init>(Landroid/net/Uri;Landroid/content/ClipDescription;Landroid/net/Uri;)V

    .line 9
    invoke-interface {p2, v6, v5, p1}, Ls/b$c;->a(Ls/c;ILandroid/os/Bundle;)Z
