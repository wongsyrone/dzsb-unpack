...
.method public static a(Lcom/amap/api/location/DPoint;Lcom/amap/api/location/DPoint;Lcom/amap/api/location/DPoint;)D
    .locals 11
    ...
    invoke-static {v2, p0}, Lz6/n4;->d(Lcom/amap/api/location/DPoint;Lcom/amap/api/location/DPoint;)F
...
.method public static declared-synchronized c()J
    ...
    sget-wide v3, Lz6/a1;->a:J

    cmp-long v5, v1, v3

    if-lez v5, :cond_0

    sput-wide v1, Lz6/a1;->a:J

    goto :goto_0

    :cond_0
    sget-wide v1, Lz6/a1;->a:J
...
.method private d(Ljava/util/List;F)Ljava/util/List;
    ...
    invoke-static {v9, v4, v5}, Lz6/a1;->a(Lcom/amap/api/location/DPoint;Lcom/amap/api/location/DPoint;Lcom/amap/api/location/DPoint;)D
    ...
    invoke-direct {p0, v0, p2}, Lz6/a1;->d(Ljava/util/List;F)Ljava/util/List;
    ...
    invoke-direct {p0, p1, p2}, Lz6/a1;->d(Ljava/util/List;F)Ljava/util/List;
...
.method public static e(Ljava/lang/String;Ljava/util/List;Landroid/os/Bundle;)I
    ...
    invoke-static {p0, p1, p2}, Lz6/a1;->b(Ljava/lang/String;Ljava/util/List;Landroid/os/Bundle;)I
...
.method public final f(Ljava/lang/String;Ljava/util/List;Landroid/os/Bundle;)I
    ...
    :try_start_2
    invoke-direct {v3, v6, v5}, Lz6/a1;->d(Ljava/util/List;F)Ljava/util/List;
    ...
    invoke-static {v4, v6}, Lz6/a;->z(Lcom/amap/api/location/DPoint;Ljava/util/List;)F
    ...
    invoke-static {v4, v6}, Lz6/a;->b(Lcom/amap/api/location/DPoint;Ljava/util/List;)F
