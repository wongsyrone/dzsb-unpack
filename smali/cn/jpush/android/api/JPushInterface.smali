...
.method public static addLocalNotification(Landroid/content/Context;Lcn/jpush/android/data/JPushLocalNotification;)V
    ...
    invoke-static {p0, p1}, Lcn/jpush/android/bg/d;->a(Landroid/content/Context;Lcn/jpush/android/data/JPushLocalNotification;)V
...
.method public static checkLengthOfTags(Ljava/lang/String;)Z
    .locals 3
...
.method public static clearLocalNotifications(Landroid/content/Context;)V
    ...
    invoke-static {p0}, Lcn/jpush/android/bg/d;->a(Landroid/content/Context;)V
...
.method public static filterValidTags(Ljava/util/Set;)Ljava/util/Set;
    ...
    invoke-static {p0}, Lcn/jpush/android/bs/a;->a(Ljava/util/Set;)Ljava/util/Set;
...
.method public static getStringTags(Ljava/util/Set;)Ljava/lang/String;
    ...
    invoke-static {p0}, Lcn/jpush/android/bs/a;->b(Ljava/util/Set;)Ljava/lang/String;
...
.method public static goToAppNotificationSettings(Landroid/content/Context;)V
    ...
    const-string v1, "go_settings"

    const/4 v2, 0x0

    invoke-static {p0, v0, v1, v2}, Lcn/jpush/android/helper/JCoreHelper;->runActionWithService(Landroid/content/Context;Ljava/lang/String;Ljava/lang/String;Landroid/os/Bundle;)V

    invoke-static {p0}, Lcn/jpush/android/bi/b;->e(Landroid/content/Context;)Z

    move-result v0

    if-nez v0, :cond_0

    invoke-static {p0}, Lcn/jpush/android/bi/b;->f(Landroid/content/Context;)Z
...
.method public static init(Landroid/content/Context;)V
    ...
    invoke-static {p0}, Lcn/jpush/android/bu/a;->h(Landroid/content/Context;)Z
...
.method public static removeLocalNotification(Landroid/content/Context;J)V
    ...
    invoke-static {p0, p1, p2}, Lcn/jpush/android/bg/d;->a(Landroid/content/Context;J)V
...
.method public static setPushTime(Landroid/content/Context;Ljava/util/Set;II)V
    ...
    invoke-static {p0}, Lcn/jpush/android/bu/a;->a(Landroid/content/Context;)Z
