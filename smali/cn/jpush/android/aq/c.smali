.class public Lcn/jpush/android/aq/c;
.super Ljava/lang/Object;
.source "SourceFile"


# static fields
.field public static a:Ljava/lang/String; = "apk_res"
...
.method public static a()Ljava/lang/String;
    ...
    const-string v0, "InAppDownloadConfig"

    sget-object v1, Lcn/jpush/android/aq/c;->b:Ljava/lang/String;
    ...
    sget-object v0, Lcn/jpush/android/aq/c;->b:Ljava/lang/String;
    ...
    :cond_1
    invoke-static {v2}, Lcn/jpush/android/bu/a;->k(Landroid/content/Context;)Landroid/content/pm/ProviderInfo;

    move-result-object v3

    if-eqz v3, :cond_2

    invoke-static {v2, v3}, Lcn/jpush/android/aq/c;->a(Landroid/content/Context;Landroid/content/pm/ProviderInfo;)Ljava/lang/String;
    ...
    const-string v4, "parse xml download file path failed, buildVersion: "
    ...
    sput-object v1, Lcn/jpush/android/aq/c;->b:Ljava/lang/String;

    return-object v1
.end method

.method public static a(Landroid/content/Context;Landroid/content/pm/ProviderInfo;)Ljava/lang/String;
    .locals 16

    const-string v0, "JAdDownload"

    const-string v1, ""

    const-string v2, "InAppDownloadConfig"
    ...
    const-string v0, "[parseXmlFileMetaData] getPackageManager pm is null"
    ...
    const-string v0, "[resolveContentProvider] provider info is null"
    ...
    const-string v0, "get metaData from resolveContentProvider is null"
    ...
    invoke-virtual {v4, v3, v5}, Landroid/content/pm/ProviderInfo;->loadXmlMetaData(Landroid/content/pm/PackageManager;Ljava/lang/String;)Landroid/content/res/XmlResourceParser;
    ...
    invoke-virtual {v8, v14}, Landroid/content/Context;->getExternalFilesDir(Ljava/lang/String;)Ljava/io/File;
    ...
    const-string v4, "apk download path: "
    ...
    const-string v4, "parse provider meta-data failed, "
...
.method public static a(Landroid/content/Context;)Ljava/util/LinkedHashMap;
    ...
    const-string v1, "InAppDownloadConfig"
    ...
    invoke-static {v4}, Lcn/jpush/android/aq/d;->a(Ljava/lang/String;)Lcn/jpush/android/aq/d;

    move-result-object v4

    if-eqz v4, :cond_1

    iget-object v5, v4, Lcn/jpush/android/aq/d;->b:Ljava/lang/String;

    invoke-static {v5}, Lcn/jpush/android/bu/a;->d(Ljava/lang/String;)Ljava/lang/String;
    ...
    const-string v4, "[readDownloadConfig] config json: "
...
.method public static a(Ljava/util/LinkedHashMap;)Ljava/util/LinkedHashMap;
    ...
    new-instance p0, Lcn/jpush/android/aq/c$1;

    invoke-direct {p0}, Lcn/jpush/android/aq/c$1;-><init>()V
    ...
    const-string v2, "sort file map filed. error: "
...
.method public static a(Landroid/content/Context;Ljava/util/LinkedHashMap;)V
    ...
    invoke-static {p1}, Lcn/jpush/android/aq/c;->a(Ljava/util/LinkedHashMap;)Ljava/util/LinkedHashMap;
    ...
    check-cast v6, Lcn/jpush/android/aq/d;
    ...
    invoke-virtual {v6}, Lcn/jpush/android/aq/d;->e()Ljava/lang/String;
    ...
    :cond_1
    invoke-virtual {v6}, Lcn/jpush/android/aq/d;->b()Ljava/lang/String;
    ...
    const-string v3, "[saveDownloadConfig] cache config info: "
    ...
    const-string v1, "save download config to file failed. error: "
