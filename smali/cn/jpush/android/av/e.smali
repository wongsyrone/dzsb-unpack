.class public Lcn/jpush/android/av/e;
.super Ljava/lang/Object;
.source "SourceFile"


# static fields
.field public static a:Lcn/jpush/android/av/e;
...
.method public constructor <init>()V
    ...
    iput v0, p0, Lcn/jpush/android/av/e;->b:I

    const-wide/16 v0, 0x7530

    iput-wide v0, p0, Lcn/jpush/android/av/e;->c:J

    const/4 v0, 0x0

    iput v0, p0, Lcn/jpush/android/av/e;->d:I

    const-wide/16 v0, 0x0

    iput-wide v0, p0, Lcn/jpush/android/av/e;->e:J

    new-instance v0, Ljava/util/concurrent/ConcurrentHashMap;

    invoke-direct {v0}, Ljava/util/concurrent/ConcurrentHashMap;-><init>()V

    iput-object v0, p0, Lcn/jpush/android/av/e;->f:Ljava/util/concurrent/ConcurrentHashMap;

    return-void
.end method

.method public static a()Lcn/jpush/android/av/e;
    .locals 2

    sget-object v0, Lcn/jpush/android/av/e;->a:Lcn/jpush/android/av/e;

    if-nez v0, :cond_1

    const-class v0, Lcn/jpush/android/av/e;

    monitor-enter v0

    :try_start_0
    sget-object v1, Lcn/jpush/android/av/e;->a:Lcn/jpush/android/av/e;

    if-nez v1, :cond_0

    new-instance v1, Lcn/jpush/android/av/e;

    invoke-direct {v1}, Lcn/jpush/android/av/e;-><init>()V

    sput-object v1, Lcn/jpush/android/av/e;->a:Lcn/jpush/android/av/e;
...
.method private a(Landroid/content/Context;JI)V
    ...
    iget-object v0, p0, Lcn/jpush/android/av/e;->f:Ljava/util/concurrent/ConcurrentHashMap;
    ...
    invoke-static {v0, p3}, Lcn/jpush/android/r/b;->b(Ljava/lang/String;Ljava/lang/String;)V
    ...
    invoke-direct {p0, p1, p2, p4}, Lcn/jpush/android/av/e;->a(Landroid/content/Context;II)V
...
.method public a(Landroid/content/Context;Landroid/content/Intent;)Lcn/jpush/android/api/JPushMessage;
    ...
    invoke-static {p1}, Lcn/jpush/android/bu/a;->d(Landroid/content/Context;)Ljava/lang/String;
...
.method public a(Landroid/content/Context;JIIJ)V
    ...
    iput p5, p0, Lcn/jpush/android/av/e;->b:I
    ...
    iput-wide p5, p0, Lcn/jpush/android/av/e;->c:J
    ...
    iget p6, p0, Lcn/jpush/android/av/e;->b:I
    ...
    iget-wide p6, p0, Lcn/jpush/android/av/e;->c:J
    ...
    invoke-static {v0, p5}, Lcn/jpush/android/r/b;->b(Ljava/lang/String;Ljava/lang/String;)V

    :cond_0
    invoke-direct {p0, p1, p2, p3, p4}, Lcn/jpush/android/av/e;->a(Landroid/content/Context;JI)V
    :try_end_0
    .catchall {:try_start_0 .. :try_end_0} :catchall_0
...
.method public declared-synchronized a(Landroid/content/Context;Landroid/os/Bundle;)V
    ...
    invoke-static {v11, v12, v0, v2}, Lcn/jpush/android/ae/c;->a(Landroid/content/Context;IILjava/lang/String;)V
    :try_end_0
    ...
    sget v6, Lcn/jpush/android/local/JPushConstants;->SDK_VERSION_CODE:I
    :try_end_1
    ...
    :try_start_3
    const-string v6, "InAppPullTaskHelper"

    new-instance v7, Ljava/lang/StringBuilder;

    invoke-direct {v7}, Ljava/lang/StringBuilder;-><init>()V

    const-string v8, "parse adSlot data failed, "
    ...
    invoke-direct {v1, v11, v2, v3}, Lcn/jpush/android/av/e;->a(Landroid/content/Context;II)V

    const/16 v2, 0x68

    invoke-static {v11, v12, v2, v0}, Lcn/jpush/android/ae/c;->a(Landroid/content/Context;IILjava/lang/String;)V
    :try_end_3
    ...
    :cond_5
    :try_start_4
    invoke-static/range {p1 .. p1}, Lcn/jpush/android/bu/a;->a(Landroid/content/Context;)Z
    ...
    const-string v3, "InAppPullTaskHelper"
    ...
    iget-wide v6, v1, Lcn/jpush/android/av/e;->e:J

    sub-long v6, v8, v6

    iget-wide v14, v1, Lcn/jpush/android/av/e;->c:J

    cmp-long v4, v6, v14

    if-lez v4, :cond_8

    iput v13, v1, Lcn/jpush/android/av/e;->d:I

    :cond_8
    iget v4, v1, Lcn/jpush/android/av/e;->d:I

    iget v6, v1, Lcn/jpush/android/av/e;->b:I
    ...
    iget v5, v1, Lcn/jpush/android/av/e;->b:I
    ...
    iget v5, v1, Lcn/jpush/android/av/e;->d:I
    ...
    iget-wide v5, v1, Lcn/jpush/android/av/e;->c:J
    ...
    iget-wide v5, v1, Lcn/jpush/android/av/e;->e:J
    ...
    invoke-static {v3, v4}, Lcn/jpush/android/r/b;->f(Ljava/lang/String;Ljava/lang/String;)V
    ...
    invoke-virtual {v7, v11}, Lcn/jpush/android/av/c;->e(Landroid/content/Context;)Ljava/lang/String;
    ...
    invoke-static {v11, v6, v13}, Lcn/jpush/android/y/b;->b(Landroid/content/Context;II)Ljava/lang/String;

    move-result-object v6

    const-string v10, "InAppPullTaskHelper"

    new-instance v12, Ljava/lang/StringBuilder;

    invoke-direct {v12}, Ljava/lang/StringBuilder;-><init>()V

    const-string v13, "start request in-app message, reqCount: "

    invoke-virtual {v12, v13}, Ljava/lang/StringBuilder;->append(Ljava/lang/String;)Ljava/lang/StringBuilder;

    iget v13, v1, Lcn/jpush/android/av/e;->b:I

    invoke-virtual {v12, v13}, Ljava/lang/StringBuilder;->append(I)Ljava/lang/StringBuilder;

    const-string v13, ", reqTimeInterval: "

    invoke-virtual {v12, v13}, Ljava/lang/StringBuilder;->append(Ljava/lang/String;)Ljava/lang/StringBuilder;

    move-object/from16 v17, v5

    iget-wide v4, v1, Lcn/jpush/android/av/e;->c:J
    ...
    invoke-static {v10, v5}, Lcn/jpush/android/r/b;->b(Ljava/lang/String;Ljava/lang/String;)V

    iget-object v5, v1, Lcn/jpush/android/av/e;->f:Ljava/util/concurrent/ConcurrentHashMap;
    ...
    invoke-virtual {v5, v10, v2}, Ljava/util/concurrent/ConcurrentHashMap;->put(Ljava/lang/Object;Ljava/lang/Object;)Ljava/lang/Object;

    invoke-static {v3, v4, v7, v6}, Lcn/jpush/android/bq/b;->a(ILjava/lang/String;Ljava/lang/String;Ljava/lang/String;)[B
    ...
    iget-wide v2, v1, Lcn/jpush/android/av/e;->e:J

    sub-long v8, v14, v2

    iget-wide v2, v1, Lcn/jpush/android/av/e;->c:J
    ...
    :cond_b
    iget v2, v1, Lcn/jpush/android/av/e;->d:I

    const/4 v3, 0x1

    add-int/2addr v2, v3

    iput v2, v1, Lcn/jpush/android/av/e;->d:I

    :goto_3
    iput v2, v1, Lcn/jpush/android/av/e;->d:I

    iput-wide v14, v1, Lcn/jpush/android/av/e;->e:J

    const/4 v2, 0x0

    const/16 v3, 0xc

    invoke-static {v11, v3, v2, v0}, Lcn/jpush/android/ae/c;->a(Landroid/content/Context;IILjava/lang/String;)V
    ...
    iget v3, v1, Lcn/jpush/android/av/e;->d:I
    ...
    iget-wide v3, v1, Lcn/jpush/android/av/e;->e:J
    ...
    invoke-static {v11, v4, v2, v3}, Lcn/jpush/android/ae/c;->a(Landroid/content/Context;IILjava/lang/String;)V
