.class public Lcn/jpush/android/bs/c;
.super Ljava/lang/Object;
.source "SourceFile"


# static fields
.field public static volatile a:Lcn/jpush/android/bs/c;

.field public static final d:Ljava/lang/Object;


# instance fields
.field public b:Lcn/jpush/android/service/TagAliasReceiver;
...
.method public static constructor <clinit>()V
    ...
    sput-object v0, Lcn/jpush/android/bs/c;->d:Ljava/lang/Object;
...
.method public constructor <init>()V
    ...
    iput-object v0, p0, Lcn/jpush/android/bs/c;->c:Ljava/util/concurrent/ConcurrentHashMap;
    ...
    iput-object v0, p0, Lcn/jpush/android/bs/c;->e:Ljava/util/concurrent/atomic/AtomicBoolean;

    return-void
.end method

.method public static a()Lcn/jpush/android/bs/c;
    .locals 2

    sget-object v0, Lcn/jpush/android/bs/c;->a:Lcn/jpush/android/bs/c;

    if-nez v0, :cond_1

    sget-object v0, Lcn/jpush/android/bs/c;->d:Ljava/lang/Object;

    monitor-enter v0

    :try_start_0
    sget-object v1, Lcn/jpush/android/bs/c;->a:Lcn/jpush/android/bs/c;

    if-nez v1, :cond_0

    new-instance v1, Lcn/jpush/android/bs/c;

    invoke-direct {v1}, Lcn/jpush/android/bs/c;-><init>()V

    sput-object v1, Lcn/jpush/android/bs/c;->a:Lcn/jpush/android/bs/c;
...
.method private a(Landroid/content/Context;IJ)V
    ...
    invoke-virtual {p0, p3, p4}, Lcn/jpush/android/bs/c;->a(J)Lcn/jpush/android/api/CallBackParams;
    ...
    :cond_1
    invoke-virtual {p0, p3, p4}, Lcn/jpush/android/bs/c;->b(J)V

    const/4 p3, 0x0

    invoke-direct {p0, p1, v0, p2, p3}, Lcn/jpush/android/bs/c;->a(Landroid/content/Context;Lcn/jpush/android/api/CallBackParams;IZ)V
...
.method private a(Landroid/content/Context;IJLandroid/content/Intent;)V
    ...
    invoke-virtual {v2, p3, p4}, Lcn/jpush/android/bs/c;->b(J)V
...
.method private c(Landroid/content/Context;)V
    ...
    iget-object v0, p0, Lcn/jpush/android/bs/c;->c:Ljava/util/concurrent/ConcurrentHashMap;
    ...
    iget-object v1, p0, Lcn/jpush/android/bs/c;->c:Ljava/util/concurrent/ConcurrentHashMap;
    ...
    invoke-direct {p0, p1, v2, v3, v4}, Lcn/jpush/android/bs/c;->a(Landroid/content/Context;IJ)V
...
.method public a(Landroid/content/Context;Landroid/content/Intent;)Lcn/jpush/android/api/JPushMessage;
    ...
    invoke-virtual {p0, v0, v1}, Lcn/jpush/android/bs/c;->a(J)Lcn/jpush/android/api/CallBackParams;
    ...
    invoke-virtual {v5, v0, v1}, Lcn/jpush/android/bs/c;->b(J)V
    ...
    invoke-direct {p0, v3}, Lcn/jpush/android/bs/c;->a(Lcn/jpush/android/api/CallBackParams;)Ljava/lang/String;
...
.method public declared-synchronized a(Landroid/content/Context;)V
    ...
    :try_start_0
    iget-object v0, p0, Lcn/jpush/android/bs/c;->e:Ljava/util/concurrent/atomic/AtomicBoolean;
    ...
    iget-object v1, p0, Lcn/jpush/android/bs/c;->b:Lcn/jpush/android/service/TagAliasReceiver;
    ...
    iput-object v1, p0, Lcn/jpush/android/bs/c;->b:Lcn/jpush/android/service/TagAliasReceiver;
    ...
    iget-object p1, p0, Lcn/jpush/android/bs/c;->e:Ljava/util/concurrent/atomic/AtomicBoolean;
...
.method public a(Landroid/content/Context;JILandroid/content/Intent;)V
    ...
    invoke-virtual {v1}, Lcn/jpush/android/bs/c;->b()Ljava/util/concurrent/ConcurrentHashMap;
    ...
    invoke-direct {p0, p1, p4, p2, p3}, Lcn/jpush/android/bs/c;->a(Landroid/content/Context;IJ)V
    ...
    invoke-direct/range {v0 .. v5}, Lcn/jpush/android/bs/c;->a(Landroid/content/Context;IJLandroid/content/Intent;)V

    :goto_0
    invoke-virtual {p0, p1}, Lcn/jpush/android/bs/c;->b(Landroid/content/Context;)V
...
.method public a(Landroid/content/Context;Ljava/lang/Long;Lcn/jpush/android/api/CallBackParams;)V
    ...
    invoke-direct {p0, p1}, Lcn/jpush/android/bs/c;->c(Landroid/content/Context;)V

    iget-object p1, p0, Lcn/jpush/android/bs/c;->c:Ljava/util/concurrent/ConcurrentHashMap;
...
.method public declared-synchronized b(Landroid/content/Context;)V
    ...
    :try_start_1
    iget-object v0, p0, Lcn/jpush/android/bs/c;->b:Lcn/jpush/android/service/TagAliasReceiver;
    ...
    iput-object p1, p0, Lcn/jpush/android/bs/c;->b:Lcn/jpush/android/service/TagAliasReceiver;
    :try_end_1
