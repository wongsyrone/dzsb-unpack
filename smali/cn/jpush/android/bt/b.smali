.class public Lcn/jpush/android/bt/b;
...
.method public static a(Landroid/content/Context;Lcn/jpush/android/d/d;)V
    ...
    invoke-static {p0, v1, p1}, Lcn/jpush/android/bi/b;->b(Landroid/content/Context;Ljava/lang/String;Lcn/jpush/android/d/d;)Landroid/content/Intent;
    ...
    :cond_0
    invoke-static {p0, v1, p1}, Lcn/jpush/android/bi/b;->a(Landroid/content/Context;Ljava/lang/String;Lcn/jpush/android/d/d;)Landroid/content/Intent;
...
.method public static a(Landroid/content/Context;Lcn/jpush/android/d/d;Ljava/lang/String;I)V
    .locals 1
    ...
    invoke-static {p0, p3, p1, v0}, Lcn/jpush/android/bi/b;->a(Landroid/content/Context;Ljava/lang/String;Lcn/jpush/android/d/d;Landroid/content/Intent;)V

    iget-object p3, p1, Lcn/jpush/android/d/d;->d:Ljava/lang/String;

    iget-byte p1, p1, Lcn/jpush/android/d/d;->af:B
...
.method public static a(Landroid/content/Context;Ljava/lang/String;Ljava/lang/String;IBI)V
    ...
    invoke-static {p0, p1, p2}, Lcn/jpush/android/bt/b;->a(Landroid/content/Context;Ljava/lang/String;Ljava/lang/String;)Lcn/jpush/android/d/d;
    ...
    :cond_3
    iput-byte p4, p1, Lcn/jpush/android/d/d;->af:B
    ...
    :cond_4
    invoke-static {p0, p1, p2, p3}, Lcn/jpush/android/bt/b;->b(Landroid/content/Context;Lcn/jpush/android/d/d;Ljava/lang/String;I)V

    goto :goto_1

    :cond_5
    invoke-static {p0, p1, p2, p3}, Lcn/jpush/android/bt/b;->a(Landroid/content/Context;Lcn/jpush/android/d/d;Ljava/lang/String;I)V

    goto :goto_1

    :cond_6
    invoke-static {p0, p1, p2, p3}, Lcn/jpush/android/bt/b;->c(Landroid/content/Context;Lcn/jpush/android/d/d;Ljava/lang/String;I)V
    ...
    invoke-static {p0, p2}, Lcn/jpush/android/bi/d;->a(Landroid/content/Context;Ljava/util/List;)V

    :goto_1
    return-void
.end method

.method public static b(Landroid/content/Context;Lcn/jpush/android/d/d;Ljava/lang/String;I)V
    .locals 2
...
.method public static c(Landroid/content/Context;Lcn/jpush/android/d/d;Ljava/lang/String;I)V
    .locals 1
    ...
    iget-boolean p3, p1, Lcn/jpush/android/d/d;->V:Z
    ...
    invoke-static {p0, v0, p1, p3}, Lcn/jpush/android/bi/b;->a(Landroid/content/Context;Ljava/lang/String;Lcn/jpush/android/d/d;Landroid/content/Intent;)V
    ...
    :cond_0
    iget-byte p2, p1, Lcn/jpush/android/d/d;->af:B

    const/16 p3, 0x8

    if-ne p2, p3, :cond_1

    invoke-static {p0, p1}, Lcn/jpush/android/bt/b;->a(Landroid/content/Context;Lcn/jpush/android/d/d;)V
