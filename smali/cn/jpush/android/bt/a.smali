.class public Lcn/jpush/android/bt/a;
...
.annotation system Ldalvik/annotation/MemberClasses;
    value = {
        Lcn/jpush/android/bt/a$a;
    }
.end annotation


# static fields
.field public static volatile b:Lcn/jpush/android/bt/a;
...
.method public constructor <init>()V
    ...
    iput-object v0, p0, Lcn/jpush/android/bt/a;->a:Ljava/util/Map;

    return-void
.end method

.method private a(J)Lcn/jpush/android/bt/a$a;
    .locals 5

    iget-object v0, p0, Lcn/jpush/android/bt/a;->a:Ljava/util/Map;
    ...
    check-cast v2, Lcn/jpush/android/bt/a$a;

    iget-wide v2, v2, Lcn/jpush/android/bt/a$a;->c:J
    ...
    check-cast p1, Lcn/jpush/android/bt/a$a;
...
.method public static a()Lcn/jpush/android/bt/a;
    .locals 2

    sget-object v0, Lcn/jpush/android/bt/a;->b:Lcn/jpush/android/bt/a;

    if-nez v0, :cond_1

    const-class v0, Lcn/jpush/android/bt/a;

    monitor-enter v0

    :try_start_0
    sget-object v1, Lcn/jpush/android/bt/a;->b:Lcn/jpush/android/bt/a;

    if-nez v1, :cond_0

    new-instance v1, Lcn/jpush/android/bt/a;

    invoke-direct {v1}, Lcn/jpush/android/bt/a;-><init>()V

    sput-object v1, Lcn/jpush/android/bt/a;->b:Lcn/jpush/android/bt/a;
...
.method private declared-synchronized a(Landroid/content/Context;Lcn/jpush/android/bt/a$a;)V
    .locals 9
    ...
    iget-wide v4, p2, Lcn/jpush/android/bt/a$a;->c:J

    const-wide/16 v6, 0x2710

    iget-object v8, p2, Lcn/jpush/android/bt/a$a;->d:[B
...
.method private b(Landroid/content/Context;BLjava/lang/String;)V
    ...
    invoke-static {p3, p2}, Lcn/jpush/android/bq/b;->a(Ljava/lang/String;B)[B

    move-result-object v6

    new-instance v7, Lcn/jpush/android/bt/a$a;
    ...
    invoke-direct/range {v0 .. v6}, Lcn/jpush/android/bt/a$a;-><init>(Lcn/jpush/android/bt/a;BLjava/lang/String;J[B)V

    iget-object p3, p0, Lcn/jpush/android/bt/a;->a:Ljava/util/Map;
    ...
    invoke-direct {p0, p1, v7}, Lcn/jpush/android/bt/a;->a(Landroid/content/Context;Lcn/jpush/android/bt/a$a;)V
...
.method public declared-synchronized a(Landroid/content/Context;BLjava/lang/String;)V
    ...
    check-cast v0, Lcn/jpush/android/bt/a$a;

    iget-object v0, v0, Lcn/jpush/android/bt/a$a;->b:Ljava/lang/String;
    ...
    :cond_1
    :try_start_2
    invoke-direct {p0, p1, p2, p3}, Lcn/jpush/android/bt/a;->b(Landroid/content/Context;BLjava/lang/String;)V
...
.method public a(Landroid/content/Context;J)V
    ...
    invoke-direct {p0, p2, p3}, Lcn/jpush/android/bt/a;->a(J)Lcn/jpush/android/bt/a$a;
    ...
    iget-byte v1, v0, Lcn/jpush/android/bt/a$a;->a:B

    invoke-static {v1}, Lcn/jpush/android/cache/Key;->ThirdPush_RegID(B)Lcn/jpush/android/cache/Key;

    move-result-object v1

    iget-object v2, v0, Lcn/jpush/android/bt/a$a;->b:Ljava/lang/String;
    ...
    iget-byte p3, v0, Lcn/jpush/android/bt/a$a;->a:B
    ...
    iget-object p2, p0, Lcn/jpush/android/bt/a;->a:Ljava/util/Map;
    ...
    invoke-virtual {p2, p1, p3, v0}, Lcn/jpush/android/bt/c;->a(Landroid/content/Context;ILjava/lang/String;)V
...
.method public a(Landroid/content/Context;JI)V
    ...
    iget p2, v0, Lcn/jpush/android/bt/a$a;->e:I
    ...
    iput p2, v0, Lcn/jpush/android/bt/a$a;->e:I

    invoke-direct {p0, p1, v0}, Lcn/jpush/android/bt/a;->a(Landroid/content/Context;Lcn/jpush/android/bt/a$a;)V
    ...
    iget-object p1, p0, Lcn/jpush/android/bt/a;->a:Ljava/util/Map;

    iget-byte p2, v0, Lcn/jpush/android/bt/a$a;->a:B
