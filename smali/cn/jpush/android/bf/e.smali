.class public Lcn/jpush/android/bf/e;
...
.field public static f:Lcn/jpush/android/bf/e;
...
.field public volatile d:Ljava/util/LinkedHashMap;
...
.field public g:Lcn/jpush/android/bf/e$a;
...
.method public constructor <init>()V
    ...
    iput v0, p0, Lcn/jpush/android/bf/e;->b:I

    return-void
.end method

.method public static a(Lcn/jpush/android/d/d;)Lcn/jpush/android/b/b;
    .locals 3
    ...
    iget-wide v1, p0, Lcn/jpush/android/d/d;->ai:J

    iput-wide v1, v0, Lcn/jpush/android/b/b;->b:J

    iget-object v1, p0, Lcn/jpush/android/d/d;->aj:Ljava/lang/String;

    iput-object v1, v0, Lcn/jpush/android/b/b;->c:Ljava/lang/String;

    iget-boolean v1, p0, Lcn/jpush/android/d/d;->ak:Z
    ...
    iget-wide v1, p0, Lcn/jpush/android/d/d;->ao:D

    iput-wide v1, v0, Lcn/jpush/android/b/b;->g:D

    iget-object p0, p0, Lcn/jpush/android/d/d;->ap:Ljava/lang/String;
...
.method public static a()Lcn/jpush/android/bf/e;
    .locals 2

    sget-object v0, Lcn/jpush/android/bf/e;->f:Lcn/jpush/android/bf/e;

    if-nez v0, :cond_1

    const-class v0, Lcn/jpush/android/bf/e;

    monitor-enter v0

    :try_start_0
    sget-object v1, Lcn/jpush/android/bf/e;->f:Lcn/jpush/android/bf/e;

    if-nez v1, :cond_0

    new-instance v1, Lcn/jpush/android/bf/e;

    invoke-direct {v1}, Lcn/jpush/android/bf/e;-><init>()V

    sput-object v1, Lcn/jpush/android/bf/e;->f:Lcn/jpush/android/bf/e;
...
.method private a(Landroid/content/Context;I)Ljava/util/LinkedHashMap;
    ...
    :goto_0
    invoke-static {p1, p2}, Lcn/jpush/android/bu/c;->a(Landroid/content/Context;Ljava/lang/String;)Ljava/io/File;
    ...
    :cond_4
    :goto_2
    invoke-static {v1}, Lcn/jpush/android/bu/k;->a(Ljava/io/Closeable;)V
...
.method private a(Ljava/lang/String;Lorg/json/JSONObject;IZ)V
    ...
    invoke-direct {p0, p3}, Lcn/jpush/android/bf/e;->d(I)Ljava/util/LinkedHashMap;
    ...
    invoke-virtual {p0, v1}, Lcn/jpush/android/bf/e;->a(Lcn/jpush/android/b/b;)V
    ...
    iget-object p1, p0, Lcn/jpush/android/bf/e;->g:Lcn/jpush/android/bf/e$a;

    if-eqz p1, :cond_2

    invoke-interface {p1, v1, v1}, Lcn/jpush/android/bf/e$a;->a(Lcn/jpush/android/b/b;Lcn/jpush/android/b/b;)V

    :cond_2
    :goto_0
    invoke-direct {p0, p3}, Lcn/jpush/android/bf/e;->e(I)V
...
.method private b(Landroid/content/Context;)V
    ...
    invoke-static {p1, v4}, Lcn/jpush/android/bu/c;->a(Landroid/content/Context;Ljava/lang/String;)Ljava/io/File;
    ...
    invoke-direct {p0, p1, v1}, Lcn/jpush/android/bf/e;->a(Landroid/content/Context;I)Ljava/util/LinkedHashMap;

    move-result-object v4

    iput-object v4, p0, Lcn/jpush/android/bf/e;->e:Ljava/util/LinkedHashMap;
    ...
    invoke-direct {p0, p1, v3}, Lcn/jpush/android/bf/e;->a(Landroid/content/Context;I)Ljava/util/LinkedHashMap;

    move-result-object v4

    iput-object v4, p0, Lcn/jpush/android/bf/e;->d:Ljava/util/LinkedHashMap;
    ...
    invoke-static {v4}, Lcn/jpush/android/bu/c;->a(Ljava/io/File;)Ljava/lang/Object;
    ...
    invoke-static {v6}, Lcn/jpush/android/bf/e;->a(Lcn/jpush/android/d/d;)Lcn/jpush/android/b/b;
    ...
    iput-object v5, p0, Lcn/jpush/android/bf/e;->d:Ljava/util/LinkedHashMap;
    ...
    iget-object v4, p0, Lcn/jpush/android/bf/e;->d:Ljava/util/LinkedHashMap;
    ...
    sget v7, Lcn/jpush/android/be/b;->a:I
    ...
    :goto_5
    iget-object p1, p0, Lcn/jpush/android/bf/e;->e:Ljava/util/LinkedHashMap;
    ...
    iput-object p1, p0, Lcn/jpush/android/bf/e;->e:Ljava/util/LinkedHashMap;

    :cond_5
    iget-object p1, p0, Lcn/jpush/android/bf/e;->d:Ljava/util/LinkedHashMap;
    ...
    iput-object p1, p0, Lcn/jpush/android/bf/e;->d:Ljava/util/LinkedHashMap;
    ...
    iget-object v2, p0, Lcn/jpush/android/bf/e;->e:Ljava/util/LinkedHashMap;
    ...
    :cond_8
    :goto_7
    invoke-direct {p0, v1}, Lcn/jpush/android/bf/e;->b(I)Z

    move-result p1

    invoke-direct {p0, v3}, Lcn/jpush/android/bf/e;->b(I)Z
    ...
    :cond_9
    invoke-direct {p0, v3}, Lcn/jpush/android/bf/e;->c(I)V
    ...
    :cond_b
    invoke-direct {p0, v1}, Lcn/jpush/android/bf/e;->c(I)V
    ...
    iget-object v1, p0, Lcn/jpush/android/bf/e;->d:Ljava/util/LinkedHashMap;
    ...
    iget-object v1, p0, Lcn/jpush/android/bf/e;->e:Ljava/util/LinkedHashMap;
...
.method private c(I)V
    ...
    invoke-direct {p0, v0}, Lcn/jpush/android/bf/e;->c(I)V

    const/4 p1, 0x1

    invoke-direct {p0, p1}, Lcn/jpush/android/bf/e;->c(I)V
    ...
    :cond_2
    :try_start_0
    iget-object v2, p0, Lcn/jpush/android/bf/e;->a:Landroid/content/Context;

    invoke-static {v2, v0}, Lcn/jpush/android/bu/c;->a(Landroid/content/Context;Ljava/lang/String;)Ljava/io/File;
    ...
    invoke-static {p1, v0}, Lcn/jpush/android/bu/c;->a(Ljava/lang/String;Ljava/lang/String;)Z
    :try_end_0
    .catchall {:try_start_0 .. :try_end_0} :catchall_0
...
.method private e(I)V
    ...
    iget-object v0, p0, Lcn/jpush/android/bf/e;->d:Ljava/util/LinkedHashMap;
    ...
    iget-object v0, p0, Lcn/jpush/android/bf/e;->e:Ljava/util/LinkedHashMap;
    ...
    :goto_0
    invoke-interface {p1, v0}, Lcn/jpush/android/bf/e$a;->a(Z)V
...
.method private f(I)V
    ...
    invoke-virtual {p0, v2}, Lcn/jpush/android/bf/e;->a(Lcn/jpush/android/b/b;)V
...
.method public a(I)V
    ...
    iget-object v0, p0, Lcn/jpush/android/bf/e;->a:Landroid/content/Context;

    invoke-static {v0, p1}, Lcn/jpush/android/cache/a;->d(Landroid/content/Context;I)V

    iput p1, p0, Lcn/jpush/android/bf/e;->b:I

    invoke-direct {p0, p1}, Lcn/jpush/android/bf/e;->f(I)V
...
.method public declared-synchronized a(Landroid/content/Context;)V
    ...
    iput-object v0, p0, Lcn/jpush/android/bf/e;->a:Landroid/content/Context;
    ...
    invoke-direct {p0, p1}, Lcn/jpush/android/bf/e;->b(Landroid/content/Context;)V

    iget p1, p0, Lcn/jpush/android/bf/e;->b:I
...
.method public a(Lcn/jpush/android/b/b;)V
    ...
    invoke-direct {p0, v0}, Lcn/jpush/android/bf/e;->d(I)Ljava/util/LinkedHashMap;
    ...
    invoke-direct {p0, v0}, Lcn/jpush/android/bf/e;->e(I)V

    iget-object v0, p0, Lcn/jpush/android/bf/e;->g:Lcn/jpush/android/bf/e$a;

    if-eqz v0, :cond_2

    invoke-interface {v0, p1}, Lcn/jpush/android/bf/e$a;->b(Lcn/jpush/android/b/b;)V
...
.method public a(Lcn/jpush/android/bf/e$a;)V
    .locals 0

    iput-object p1, p0, Lcn/jpush/android/bf/e;->g:Lcn/jpush/android/bf/e$a;
...
.method public a(Ljava/lang/String;)V
    ...
    invoke-virtual {p0, v0}, Lcn/jpush/android/bf/e;->a(Lcn/jpush/android/b/b;)V
...
.method public a(Ljava/lang/String;Lorg/json/JSONObject;Z)V
    ...
    :cond_1
    invoke-direct {p0, p1, p2, v2, p3}, Lcn/jpush/android/bf/e;->a(Ljava/lang/String;Lorg/json/JSONObject;IZ)V

    const/4 v0, 0x2

    :goto_0
    invoke-direct {p0, p1, p2, v0, p3}, Lcn/jpush/android/bf/e;->a(Ljava/lang/String;Lorg/json/JSONObject;IZ)V
...
.method public a(Lorg/json/JSONArray;)V
    ...
    sget v3, Lcn/jpush/android/bf/e;->c:I
    ...
    :cond_1
    sget v2, Lcn/jpush/android/bf/e;->c:I
    ...
    :cond_2
    iput-object v0, p0, Lcn/jpush/android/bf/e;->e:Ljava/util/LinkedHashMap;

    const/4 p1, 0x2

    invoke-direct {p0, p1}, Lcn/jpush/android/bf/e;->e(I)V
    ...
    invoke-interface {p1, v0, v0}, Lcn/jpush/android/bf/e$a;->a(Lcn/jpush/android/b/b;Lcn/jpush/android/b/b;)V
...
.method public b(Lcn/jpush/android/b/b;)V
    ...
    invoke-direct {p0, p1}, Lcn/jpush/android/bf/e;->c(Lcn/jpush/android/b/b;)Z
    ...
    iget-object v1, p0, Lcn/jpush/android/bf/e;->g:Lcn/jpush/android/bf/e$a;

    if-eqz v1, :cond_5

    invoke-interface {v1, v2, p1}, Lcn/jpush/android/bf/e$a;->a(Lcn/jpush/android/b/b;Lcn/jpush/android/b/b;)V
    ...
    sget v6, Lcn/jpush/android/bf/e;->c:I
    ...
    sget v1, Lcn/jpush/android/bf/e;->c:I
    ...
    :cond_4
    iget v2, p0, Lcn/jpush/android/bf/e;->b:I

    add-int/lit8 v2, v2, -0x1

    invoke-direct {p0, v2}, Lcn/jpush/android/bf/e;->f(I)V
    ...
    invoke-interface {v1, p1}, Lcn/jpush/android/bf/e$a;->a(Lcn/jpush/android/b/b;)V
