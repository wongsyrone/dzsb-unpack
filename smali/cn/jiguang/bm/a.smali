...
.method public static a(Landroid/content/Context;[BLjava/lang/String;)Landroid/util/Pair;
    ...
    new-instance v5, Lcn/jiguang/bm/c;

    invoke-direct {v5, v4, v0}, Lcn/jiguang/bm/c;-><init>(Z[B)V
    ...
    invoke-virtual {v5}, Lcn/jiguang/bm/c;->toString()Ljava/lang/String;
    ...
    iget v0, v5, Lcn/jiguang/bm/c;->a:I
    ...
    invoke-static {v2, v6}, Lcn/jiguang/bd/d;->a(Ljava/lang/String;Ljava/lang/String;)V
    ...
    :try_start_0
    iget-byte p1, v5, Lcn/jiguang/bm/c;->d:B

    const/4 v0, 0x2

    if-ne p1, v0, :cond_3

    new-instance p1, Lcn/jiguang/by/d;

    invoke-direct {p1}, Lcn/jiguang/by/d;-><init>()V

    invoke-virtual {p1, p0, p2}, Lcn/jiguang/by/d;->b([BLjava/lang/String;)[B
    ...
    invoke-static {p0, p2, p1, v4}, Lcn/jiguang/by/e;->a([BLjava/lang/String;Ljava/lang/String;Z)[B
...
.method public static a(Landroid/content/Context;[B)Z
    ...
    invoke-static {p0, p1, v1}, Lcn/jiguang/bm/a;->a(Landroid/content/Context;[BLjava/lang/String;)Landroid/util/Pair;
    ...
    iget-wide v4, v4, Lcn/jiguang/bm/c;->g:J
    ...
    invoke-virtual {p1, p0, v2, v1}, Lcn/jiguang/bk/b;->a(Landroid/content/Context;Lcn/jiguang/bm/c;Ljava/nio/ByteBuffer;)V
    :try_end_0
