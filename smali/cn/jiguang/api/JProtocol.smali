...
.field public static final PACKET_SIZE:I = 0x1c00

.field public static final TAG:Ljava/lang/String; = "JProtocol"


# instance fields
.field public body:Ljava/nio/ByteBuffer;

.field public head:Lcn/jiguang/bw/c;
...
.method public constructor <init>(ZIIJ)V
    ...
    new-instance v6, Lcn/jiguang/bw/c;
    ...
    invoke-direct/range {v0 .. v5}, Lcn/jiguang/bw/c;-><init>(ZIIJ)V

    iput-object v6, p0, Lcn/jiguang/api/JProtocol;->head:Lcn/jiguang/bw/c;
...
.method public constructor <init>(ZIIJIJ)V
    ...
    new-instance v11, Lcn/jiguang/bw/c;
    ...
    invoke-direct/range {v1 .. v10}, Lcn/jiguang/bw/c;-><init>(ZIIIJIJ)V

    iput-object v11, v0, Lcn/jiguang/api/JProtocol;->head:Lcn/jiguang/bw/c;
...
.method public constructor <init>(ZLjava/lang/Object;Ljava/nio/ByteBuffer;)V
    ...
    check-cast p2, Lcn/jiguang/bw/c;

    iput-object p2, p0, Lcn/jiguang/api/JProtocol;->head:Lcn/jiguang/bw/c;
    ...
    invoke-static {p1, p2}, Lcn/jiguang/bw/d;->c(Ljava/lang/String;Ljava/lang/String;)V
...
.method public constructor <init>(ZLjava/nio/ByteBuffer;[B)V
    ...
    :try_start_0
    new-instance v1, Lcn/jiguang/bw/c;

    invoke-direct {v1, p1, p3}, Lcn/jiguang/bw/c;-><init>(Z[B)V

    iput-object v1, p0, Lcn/jiguang/api/JProtocol;->head:Lcn/jiguang/bw/c;
    :try_end_0
    ...
    invoke-static {v0, p1}, Lcn/jiguang/bw/d;->c(Ljava/lang/String;Ljava/lang/String;)V
...
.method public static parseHead(Ljava/lang/Object;)[B
    ...
    :goto_0
    invoke-static {v1, p0}, Lcn/jiguang/bw/d;->c(Ljava/lang/String;Ljava/lang/String;)V

    return-object v0

    :cond_0
    instance-of v2, p0, Lcn/jiguang/bw/c;

    if-eqz v2, :cond_1

    check-cast p0, Lcn/jiguang/bw/c;

    invoke-virtual {p0}, Lcn/jiguang/bw/c;->f()[B
...
.method private final toBytes()[B
    ...
    invoke-static {v2, v0}, Lcn/jiguang/bw/d;->c(Ljava/lang/String;Ljava/lang/String;)V
    ...
    :cond_0
    iget-object v3, p0, Lcn/jiguang/api/JProtocol;->head:Lcn/jiguang/bw/c;
    ...
    invoke-virtual {v3, v4}, Lcn/jiguang/bw/c;->a(I)V

    :try_start_0
    iget-object v3, p0, Lcn/jiguang/api/JProtocol;->head:Lcn/jiguang/bw/c;

    invoke-virtual {v3}, Lcn/jiguang/bw/c;->f()[B
    ...
    invoke-static {v0}, Lcn/jiguang/bw/f;->a([B)Ljava/lang/String;
    ...
    invoke-static {v2, v1}, Lcn/jiguang/bw/d;->b(Ljava/lang/String;Ljava/lang/String;)V
...
.method public getCommand()I
    ...
    iget-object v0, p0, Lcn/jiguang/api/JProtocol;->head:Lcn/jiguang/bw/c;

    invoke-virtual {v0}, Lcn/jiguang/bw/c;->a()I
...
.method public getHead()Lcn/jiguang/bw/c;
    .locals 1
...
.method public getJuid()J
    ...
    invoke-virtual {v0}, Lcn/jiguang/bw/c;->c()J
...
.method public getRid()Ljava/lang/Long;
    ...
    invoke-virtual {v0}, Lcn/jiguang/bw/c;->b()Ljava/lang/Long;
...
.method public getSid()I
    ...
    invoke-virtual {v0}, Lcn/jiguang/bw/c;->d()I
...
.method public getVersion()I
    ...
    invoke-virtual {v0}, Lcn/jiguang/bw/c;->e()I
...
.method public toString()Ljava/lang/String;
    ...
    iget-object v1, p0, Lcn/jiguang/api/JProtocol;->head:Lcn/jiguang/bw/c;

    invoke-virtual {v1}, Lcn/jiguang/bw/c;->toString()Ljava/lang/String;
