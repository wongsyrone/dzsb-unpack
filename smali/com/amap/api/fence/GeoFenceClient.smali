...
.method public constructor <init>(Landroid/content/Context;)V
    ...
    iput-object v0, p0, Lcom/amap/api/fence/GeoFenceClient;->b:Lz6/a;
    ...
    invoke-static {p1}, Lcom/amap/api/fence/GeoFenceClient;->a(Landroid/content/Context;)Lz6/a;

    move-result-object p1

    iput-object p1, p0, Lcom/amap/api/fence/GeoFenceClient;->b:Lz6/a;
...
.method public static a(Landroid/content/Context;)Lz6/a;
    .locals 1

    new-instance v0, Lz6/a;

    invoke-direct {v0, p0}, Lz6/a;-><init>(Landroid/content/Context;)V
...
.method public addGeoFence(Lcom/amap/api/location/DPoint;FLjava/lang/String;)V
    ...
    :try_start_0
    iget-object v0, p0, Lcom/amap/api/fence/GeoFenceClient;->b:Lz6/a;

    invoke-virtual {v0, p1, p2, p3}, Lz6/a;->n(Lcom/amap/api/location/DPoint;FLjava/lang/String;)V
    :try_end_0
    .catchall {:try_start_0 .. :try_end_0} :catchall_0
...
.method public addGeoFence(Ljava/lang/String;Ljava/lang/String;)V
    ...
    invoke-virtual {v0, p1, p2}, Lz6/a;->p(Ljava/lang/String;Ljava/lang/String;)V
    :try_end_0
    .catchall {:try_start_0 .. :try_end_0} :catchall_0
...
.method public addGeoFence(Ljava/lang/String;Ljava/lang/String;Lcom/amap/api/location/DPoint;FILjava/lang/String;)V
    ...
    invoke-virtual/range {v0 .. v6}, Lz6/a;->q(Ljava/lang/String;Ljava/lang/String;Lcom/amap/api/location/DPoint;FILjava/lang/String;)V
    :try_end_0
    .catchall {:try_start_0 .. :try_end_0} :catchall_0
...
.method public addGeoFence(Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;ILjava/lang/String;)V
    ...
    invoke-virtual/range {v0 .. v5}, Lz6/a;->r(Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;ILjava/lang/String;)V
    :try_end_0
    .catchall {:try_start_0 .. :try_end_0} :catchall_0
...
.method public addGeoFence(Ljava/util/List;Ljava/lang/String;)V
    ...
    invoke-virtual {v0, p1, p2}, Lz6/a;->t(Ljava/util/List;Ljava/lang/String;)V
    :try_end_0
    .catchall {:try_start_0 .. :try_end_0} :catchall_0
...
.method public createPendingIntent(Ljava/lang/String;)Landroid/app/PendingIntent;
    ...
    invoke-virtual {v0, p1}, Lz6/a;->d(Ljava/lang/String;)Landroid/app/PendingIntent;
...
.method public getAllGeoFence()Ljava/util/List;
    ...
    :try_start_0
    iget-object v1, p0, Lcom/amap/api/fence/GeoFenceClient;->b:Lz6/a;

    invoke-virtual {v1}, Lz6/a;->B()Ljava/util/List;
...
.method public removeGeoFence(Lcom/amap/api/fence/GeoFence;)Z
    ...
    invoke-virtual {v0, p1}, Lz6/a;->v(Lcom/amap/api/fence/GeoFence;)Z
...
.method public setActivateAction(I)V
    ...
    invoke-virtual {v0, p1}, Lz6/a;->h(I)V
    :try_end_0
    .catchall {:try_start_0 .. :try_end_0} :catchall_0
...
.method public setGeoFenceAble(Ljava/lang/String;Z)V
    ...
    invoke-virtual {v0, p1, p2}, Lz6/a;->s(Ljava/lang/String;Z)V
    :try_end_0
    .catchall {:try_start_0 .. :try_end_0} :catchall_0
...
.method public setGeoFenceListener(Lcom/amap/api/fence/GeoFenceListener;)V
    ...
    invoke-virtual {v0, p1}, Lz6/a;->l(Lcom/amap/api/fence/GeoFenceListener;)V
    :try_end_0
    .catchall {:try_start_0 .. :try_end_0} :catchall_0
